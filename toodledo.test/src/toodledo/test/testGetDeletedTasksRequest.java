...
public class testGetDeletedTasksRequest {
	...
	GetDeletedTasksRequest request;
	...
	public void before() {
		...
		request = new GetDeletedTasksRequest(session, after, factory);
	}
	
	@Test
	public void when_executed_then_correct_url_is_used() throws Exception {
		request.execute();
		verify(factory).create(String.format(GetDeletedTasksRequest.URL_TEMPLATE, SESSION_KEY, after));
	}
}
